...
// router.get('/new', ensureAuthenticated, checkRoleAdmin, (req, res) => res.render('shop/shop-new'))
...
// router.get('/delete', ensureAuthenticated, checkRoleAdmin, (req, res, next) => {
...
// router.get('/edit', ensureAuthenticated, checkRoleAdmin, (req, res, next) => {
